...
## A clean, beautiful and responsive portfolio page!


<p align="center">
  <kbd>
<img src="https://drive.google.com/file/d/11MxpsHbpzSiKlcdeHstictpaked6qmVm/view?usp=sharing"></img>
  </kbd>
</p>
...
To view a live example, **[click here](https://project-portfolio-livid-omega.vercel.app/)**.
...
git clone https://github.com/Pascal509/Project_Portfolio.git
...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1qZqX8IYFOcpsB68k7k2BG5RckbWPHRmX/view?usp=sharing"
};
...
- Navigate to `package.json` and enter your domain name instead of `https://project-portfolio-livid-omega.vercel.app/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/developerFolio`, add the same to the homepage section of `package.json`.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository=https://github.com/Pascal509/Project_Portfolio)

For more information, read [hosting on Vercel](https://vercel.com/docs/deployments/overview).
